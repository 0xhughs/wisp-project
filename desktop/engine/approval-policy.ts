...
export type Admission = {source:'wisp-direct'|'wisp-local-plugin'|'wisp-compatible-plugin'|'wisp-safe-action'|'wisp-mcp'|'wisp-skill'|'wisp-ax';revision:string;describe:(args:any)=>Action};
