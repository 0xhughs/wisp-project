...
export const productFiles=['product-sdk.ts','approval-policy.ts','permission-fixtures.ts','local-permission-plugin.ts','child-verification.ts','queue-verification.ts','product.patch.yml'];
