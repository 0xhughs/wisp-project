...
func managementStateTests() throws {
    ...
    try check(!plugins.description.contains("Allow Always") && plugins.description.contains("Allow Once") && plugins.description.contains("mounted compatible plugin") && plugins.description.contains("Ask-each-time") && plugins.description.contains("Open URL") && plugins.description.contains("Accessibility") && plugins.description.contains("Privacy & Security") && plugins.description.contains("Granting Accessibility is not a tool grant") && plugins.description.contains("local time") && plugins.description.contains("Connection save is not a grant") && plugins.description.contains("MCP") && plugins.description.contains("skill tool is Ask-each-time") && plugins.description.contains("skill invocation is unavailable") && plugins.description.contains("Skill Enable is not a grant") && plugins.description.contains("visual click") && plugins.description.contains("Drawn Canary") && plugins.description.contains("Fixture Button stays on the Accessibility path") && plugins.description.contains("Screen Recording") && plugins.description.contains("Input Monitoring") && plugins.description.contains("Windows") && !plugins.description.contains("Accessibility, visual click") && !plugins.description.contains("visual click, Windows"), "permissions ask for 09, 15 and 16 tools; TCC is not Allow Once; visual click is Ask-each-time fallback; Windows stays unavailable")
    ...
    try check(pets.description.contains("Wisp orb") && pets.description.contains("Fox") && pets.description.contains("Robot") && pets.description.contains("Bird") && pets.description.contains("Cat") && pets.description.contains("Owl") && pets.description.contains("Sprout") && pets.description.contains("Capsule") && pets.description.contains("same Wisp") && pets.description.contains("skills persist") && !pets.description.contains("body selection are unavailable") && !pets.description.contains("body selection is unavailable") && !pets.description.contains("Additional bodies and body selection are unavailable") && !pets.description.contains("slice 19"), "pets inventory-backed")
