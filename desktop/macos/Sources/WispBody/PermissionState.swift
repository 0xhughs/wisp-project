...
struct PermissionRequest {
    ...
    init(_ value:[String:Any]) throws {
        ...
        guard ["wisp_permission_check","wisp_plugin_check","wisp_compatible_check"].contains(tool),source == (tool == "wisp_permission_check" ? "wisp-direct" : tool == "wisp_compatible_check" ? "wisp-compatible-plugin" : "wisp-local-plugin"),let values=value["fields"] as? [[String:String]],values.count<=12 else {throw PermissionFailure.invalid}
