...
struct ManagementState {
    ...
    var description: String {
        ...
        case .pets: return "Closed catalog: Wisp orb, Fox, and Robot. This is the same Wisp. Identity, memory, models, voice, plugins and connections stay the same. Additional official skins remain unavailable. Around twenty official skins are later scope (slice 19); no marketplace was queried."
