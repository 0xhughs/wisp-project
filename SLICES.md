...
- 11 Connections and custom MCP — in progress (Building 11-build-076 after 11-plan-075 APPROVE_PLAN). Depends on accepted 01, 03, 06; parked 10 when a connection is plugin-delivered (record 10 obligation). Non-plugin MCP may proceed with that recorded obligation.
