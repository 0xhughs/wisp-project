...
- 08 Hardware-aware local-model onboarding — in progress (08-plan-067 APPROVE_PLAN; Building 08-build-068). Depends on accepted 05 and unaccepted 07 (record 07 retest obligation). Parked 10 is not an 08 dependency. No model download without a resource plan.
