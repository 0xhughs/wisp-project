...
- 11 Connections and custom MCP — in progress (Proposed; 11-draft-074 complete; pending 11-plan-075). Depends on accepted 01, 03, 06; parked 10 when a connection is plugin-delivered (record 10 obligation). Non-plugin MCP may proceed with that recorded obligation.
