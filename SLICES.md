...
- 08 Hardware-aware local-model onboarding — in progress (Proposed BUILD persisted from 08-draft-066; pending independent 08-plan-067). Depends on accepted 05 and unaccepted 07 (record 07 retest obligation). Parked 10 is not an 08 dependency. No model download without a resource plan.
