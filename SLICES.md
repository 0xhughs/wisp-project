...
- 15 macOS accessibility computer control — in progress (Proposed 15-draft-086; pending 15-plan-087). Closed fixture-only Direct AX catalog. Depends on accepted 06 and parked 09 (record retest; do not assume NSWorkspace/voice work). Linux native AX is uncompiled/unverified here. Out: silent privilege escalation and visual fallback (16). Not Shipped.
