...
- 09 Initial safe computer actions — in progress (Proposed BUILD persisted from 09-draft-070; pending independent 09-plan-071). Depends on accepted 06 and unaccepted 07 (record 07 retest obligation). Parked 08 and 10 are not 09 dependencies. Must not become a command-execution bypass.
