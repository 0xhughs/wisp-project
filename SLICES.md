...
- 16 Visual computer-control fallback — in progress (Building 16-build-096 after 16-plan-095 APPROVE_PLAN). Closed Drawn Canary visual click inside the 15 fixture; AX remains Fixture Button path. Record 15/06/07 retest. Linux native uncompiled/unverified. Not Shipped.
...
Recommended eligible order after 07 park: 10 → 08 → 09 → 11 → 13 → 12 → 15 → 17 → 16 → 19; skip 18/20/21; 14 last among 01–14. 17 parked; next Now 16 (16-plan-095 APPROVE_PLAN; 16-build-096 Building).
